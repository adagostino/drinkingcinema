...
(function(name){
    var rangeHelper = new function() {
        this.moveCursor = function(el, atStart) {
        ...
        this.getSelectionObject = function(styleMap, $el){
        ...
        this.getRangeObject =  function($el){
